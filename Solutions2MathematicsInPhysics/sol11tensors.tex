...
\begin{eqnarray}
	\mathrm d(AB) &=& \mathrm d((A_{i_1\cdots i_p} \mathrm dx^{i_1}\wedge\cdots \wedge \mathrm dx^{i_p}) \wedge (B_{i_1\cdots i_q}  \mathrm dx^{i_1}\wedge \cdots\wedge \mathrm dx^{i_q})) \\
